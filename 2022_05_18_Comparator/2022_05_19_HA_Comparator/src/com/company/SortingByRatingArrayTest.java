...
class SortingByRatingArrayTest {
    @Test
    public void isArrayByNameSorted_shouldBeTrue() {
        ...
        SortingByRatingArray sortingByRatingArray = new SortingByRatingArray();
        Student[] students2 = sortingByRatingArray.getSortedArray(students1);
